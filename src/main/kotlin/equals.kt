fun main(args:Array<String>){
    ...
    //person1 과 person3 가 동일한 인스턴스이르모 true
    ...
    val n2 = Integer(500)
    val n3 = n1
    println(n1 == n2)   //저장하고 잇는 값을 비교 : true
    ...
    val n4 = 500
    val n5 = 500
    println(n4 === n5) //참조를 비교 : true

    println("5 in 1..10 => ${5 in 1..10}") // 5의 값이 1~10 사이에 있는지 확인
    println("5 in 10..1 => ${5 in 10..1}") //10..1 은 없음 10에서 1로 상승하면서 갈수 없음
    println("5 in 10 downTo 1 => ${5 in 10 downTo 1}")
    println("5 in 1..10 step 3 => ${5 in 1..10 step 3}")

    //?: 은 null 이면 뒤의 식을 리턴 그렇지 않으면 앞의 식을 리턴
    var x : Int? = 20
    println("${x?:100}")
    x = null
    println("${x?:100}")
